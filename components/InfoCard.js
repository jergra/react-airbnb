...
function InfoCard({
  ...
  return (
    <div
      className="flex px-2 transition duration-200 ease-out border-b cursor-pointer py-7 hover:opacity-80 hover:shadow-lg first:border-t "
    >
      ...
      <div className="flex flex-col flex-grow pl-5 pr-4 ">
        ...
        <div className="w-10 pt-2 border-b border-red-400"></div>
